  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full pointer-events-none">
        ...
        >
          <p className="font-bizud-mincho text-stone-200 w-full max-w-full text-[1.8rem] leading-[1.1] sm:text-[clamp(3rem,1.1rem+3.9vw,11rem)] sm:leading-[0.95] tracking-tighter">
            {text}
          </p>
          {imageSrc ? (
