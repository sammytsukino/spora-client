...
>(
  (
    ...
    // Always call useInView hook (hooks must be called unconditionally)
    const isInViewValue = useInView(componentRef, useInViewOptions)
    const isInView = triggerType === "inView" ? isInViewValue : false
