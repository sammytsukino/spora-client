...
const statusStyles: Record<FlaggedStatus, string> = {
  ...
  approved: "bg-lime-200 border-lime-700",
  removed: "bg-neutral-200 border-neutral-600",
};
        ...
        {items.map((item) => (
          <li key={item.id}>
            ...
            >
              ...
              {item.contentPreview && (
                <p className="mb-4 opacity-80 italic border-l-2 border-black pl-3 py-1">
                  {item.contentPreview}
                </p>
              )}
              <div
                ...
                {onStatusChange && item.status === "pending" && (
                  <>
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 border-2 border-lime-600 text-lime-700 hover:bg-lime-600 hover:text-white text-[10px] uppercase"
                    >
