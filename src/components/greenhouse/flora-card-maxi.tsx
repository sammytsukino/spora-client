...
export default function FloraCardMaxi({
  image,
  title,
  author,
  date,
  ...
  return (
    <div className={cn("flex flex-col border-2 border-neutral-800 bg-neutral-200", className)}>
      {/* Image Area */}
      <div className="relative flex-1 min-h-0 overflow-hidden border-b-2 border-neutral-800">
        <img
          src={image}
          alt={title}
      ...
      <div className="p-6 flex items-center justify-between">
        <div>
          <h3 className="font-bizud-mincho-bold text-3xl md:text-4xl mb-2 text-neutral-800">{title}</h3>
          <p className="font-jetbrains-mono text-sm text-neutral-800">
            by {author} | {date}
          </p>
        </div>
